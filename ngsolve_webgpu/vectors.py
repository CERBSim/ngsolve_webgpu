...
from webgpu.gpu import get_device
from webgpu.webgpu_api import PrimitiveTopology, Device
from webgpu.utils import buffer_from_array

from .mesh import FunctionData
...
class VectorRenderObject(RenderObject):
...
class VectorFieldRenderObject(VectorRenderObject):
    ...
    def update(self):
        ...
        self.colormap = Colormap(self.device, minval=0, maxval=1)
